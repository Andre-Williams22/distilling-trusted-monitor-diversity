...
# The MACA arms are capped by their target, and M9 tests the fix
...
| Round-2 mean, all 3 (**M9's**) | 0.700 | 0.888 | 0.525 |
...
## M9: debate without voting

M9 distils the **round-2 graded mean across all three personas** -- the debate
...
teacher is 0.700, so **M9 is predicted to land between M5 and M4 and not to
